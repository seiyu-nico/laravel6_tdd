...
class ReportTest extends TestCase
{
     ...
     * @test
     */
    public function api_customersにPOSTメソッドで顧客名をPOSTするとcustomersテーブルにそのデータが追加される()
    {
        $params = [
            'name' => '顧客名',
        ];
     ...
     * @test
     */
    public function POST_api_customersにnameが含まれていない場合422UnprocessableEntityが返却される()
    {
        $params = [];
        $response = $this->postJson('api/customers', $params);
     ...
     * @test
     */
    public function POST_api_customersにnameがからの場合422UnprocessableEntityが返却される()
    {
        $params = [
            'name' => ''
        ];
